...
{
    {
        (UINT32)CAN_STD_ID_0x01a5,
	    (tCallbackFunction)NULL,
	    STANDARD_ID,
	    MSCAN_ACC_FILTER_0,
    },
    {
        (UINT32)CAN_STD_ID_0x01b6,
	    (tCallbackFunction)NULL,
	    STANDARD_ID,
	    MSCAN_ACC_FILTER_1,
    },
    {
        (UINT32)CAN_STD_ID_0x01c7,
	    (tCallbackFunction)NULL,
	    STANDARD_ID,
	    MSCAN_ACC_FILTER_2,
    },
    {
        (UINT32)CAN_STD_ID_0x0644,
	    (tCallbackFunction)NULL,
	    STANDARD_ID,
	    MSCAN_ACC_FILTER_3,
    },
    ...
    {
        (UINT32)CAN_EXT_ID_0x1abcdef9,
	    (tCallbackFunction)NULL,
	    EXTENDED_ID,
	    MSCAN_ACC_FILTER_6,
    },
    {
        (UINT32)CAN_EXT_ID_0x1abcdefa,
	    (tCallbackFunction)NULL,
	    EXTENDED_ID,
	    MSCAN_ACC_FILTER_7,
    },
